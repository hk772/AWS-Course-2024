...
//                .withActionOnFailure("TERMINATE_JOB_FLOW");
        ...
        HadoopJarStepConfig step0 = new HadoopJarStepConfig()
                .withJar("s3://" + bucketName + "/" + jarName)
                .withMainClass("org.example.Job0");

        StepConfig stepConfig0 = new StepConfig()
                .withName("org.example.Job0")
                .withHadoopJarStep(step0)
                .withActionOnFailure("TERMINATE_JOB_FLOW");
        ...
        HadoopJarStepConfig step2 = new HadoopJarStepConfig()
                .withJar("s3://" + bucketName + "/" + jarName)
                .withMainClass("org.example.JobC0");

        StepConfig stepConfig2 = new StepConfig()
                .withName("org.example.JobC0")
...
//                .withSteps(stepConfig0)
                .withSteps(stepConfig0, stepConfig1, stepConfig2, stepConfig3)
