...
public class Count12And3 {
    ...
    public static class ReducerClass extends Reducer<WordPairKey, TextAndCountValue,Text,Text> {
        ...
        public void reduce(WordPairKey key, Iterable<TextAndCountValue> vals, Context context) throws IOException,  InterruptedException {
            ...
            for (Map.Entry<String, Long> entry : H.entrySet()) {
                ...
                Text value = new Text(matchCountSum.toString() + " " + currentCount12);
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "Count12And3");
        job.setJarByClass(Count12And3.class);
        ...
        if (isLocal) {
            ...
            FileOutputFormat.setOutputPath(job, new Path("hdfs://localhost:9000/user/hdoop/output/outCount12And3"));
        }
        else {
            ...
            FileOutputFormat.setOutputPath(job, new Path(AWSApp.baseURL + "/output/outCount12And3"));
        }
